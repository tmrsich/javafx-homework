...
public class test1 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        FlowPane sumLabel = new FlowPane();
            FlowPane.setMargin(doubleBtn, new Insets(0, 10, 0, 0));
        VBox vbox = new VBox();
        ...
        ImageView view6 = new ImageView(new Image(cardPaths[5]));
        ...
        view1.setOnMouseClicked(event -> { sum ++; label.setText("Sum: " + sum); });
        view2.setOnMouseClicked(event -> { sum += 2; label.setText("Sum: " + sum); });
        view3.setOnMouseClicked(event -> { sum += 3; label.setText("Sum: " + sum); });
        view4.setOnMouseClicked(event -> { sum += 4; label.setText("Sum: " + sum); });
        view5.setOnMouseClicked(event -> { sum += 5; label.setText("Sum: " + sum); });
        view6.setOnMouseClicked(event -> { sum += 6; label.setText("Sum: " + sum); });
        ...
        cards.getChildren().addAll(view1, view2, view3, view4, view5, view6);
